...
-  Home Spoken-Weather Semantics is committed at `da7b886`; Home Compact and
  Large-Font Resilience is committed at `1a8e14f`; 30A3A1 evidence is complete
  in its retained artifact directory; and 30A3B2 document sync is committed at
  `fb51f7b`.
